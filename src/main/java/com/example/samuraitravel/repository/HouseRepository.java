...
import com.example.samuraitravel.entity.House;
 ...
 public interface HouseRepository extends JpaRepository<House, Integer> {
	 public Page<House> findByNameLike(String keyword, Pageable pgeable);
	 
	 public Page<House> findByNameLikeOrAddressLikeOrderByCreatedAtDesc(String nameKeword, String addressKeyword, Pageable pageable);
